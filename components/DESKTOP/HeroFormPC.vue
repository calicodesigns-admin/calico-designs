<template>
  <section class="h-max max-w-[100vw] overflow-x-hidden">
    <div class="h-max w-max relative">
      <!-- #1 -->
      <div
        class="h-max w-[42vw] px-[2vw] py-[4vh] rounded-sm relative z-[1] overflow-hidden font-popins"
      >
        <NuxtImg
          ...
          alt="#"
        />
        <h2 class="text-[2rem] font-bold text-center mb-6 font-popins">
          Schedule Your Free Estimate in less than 10 seconds below ✅
        </h2>
        <form @submit.prevent="submitForm">
          <div class="h-max w-full flex gap-[2vw]">
            <!-- Name Input -->
            <div class="mb-[1rem] w-[40%]">
              <label
                for="name"
              ...
              <input
                ...
                v-model="name"
                required
                class="w-full px-[1vw] py-2 border-[1.8px] border-black rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
            </div>

            <!-- phone Input -->
            <div class="mb-[1rem] w-[60%]">
              ...
              <input
                ...
                v-model="phone"
                required
                class="[appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none block w-full px-[1vw] py-2 border-[1.8px] border-black rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
            </div>
          </div>
          ...
          <div class="mb-[2rem]">
            ...
            <textarea
              ...
              v-model="details"
              required
              class="min-h-[12vh] w-full px-[1vw] py-2 border-[1.8px] border-black rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
            ></textarea>
          </div>
          ...
          <button
            ...
            class="font-popins text-[1.4rem] w-full py-[1rem] bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-all duration-[.2s] hover:shadow-xl ease-in-out disabled:bg-gray-400 uppercase tracking-[.1vw]"
          >
            Submit
          </button>
        </form>
