...
export const sanitizePageSettingsProps = (props) => {
...
export const formatCalendlyUrl = ({
  ...
  const { backgroundColor, hideEventTypeDetails, hideLandingPageDetails, primaryColor, textColor, hideGdprBanner } = sanitizedPageSettings;
  ...
  const updatedQueryString = [
     ...
     */
    `embed_domain=1`
  ].concat(customAnswers ? formatCustomAnswers(customAnswers) : []).filter((item) => item !== null).join("&");
...
const formatCustomAnswers = (customAnswers) => {
